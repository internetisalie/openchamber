...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  ...giteaIntegrationI18n['pt-BR'],
  ...guestIntegrationsI18n['pt-BR'],
  ...extensionsSettingsI18n['pt-BR'],
  'settings.page.integrations.title': 'Integrações',
  'settings.page.integrations.description': 'Conecte o GitHub, o Gitea e o Linear para que o OpenChamber possa trabalhar com suas issues e pull requests.',
