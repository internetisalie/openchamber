...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': 'Terminale PTY agenta',
  'chat.workStatus.pty.authenticationError': 'Uwierzytelnianie nie powiodło się',
  'chat.workStatus.pty.availabilityUnknown': 'Dostępność PTY jest nieznana',
  'chat.workStatus.pty.none': 'Brak terminali PTY dla tej sesji',
  'chat.workStatus.pty.running': 'Uruchomiony',
  'chat.workStatus.pty.stopping': 'Zatrzymywanie',
  'chat.workStatus.pty.exited': 'Zakończony',
  'chat.workStatus.pty.openOutput': 'Otwórz wyjście {name}',
  'chat.workStatus.pty.readOnly': 'Tylko do odczytu',
  'chat.workStatus.pty.dialogDescription': 'Wyjście tego terminala PTY agenta tylko do odczytu.',
  'chat.workStatus.pty.outputMissing': 'Ta sesja PTY nie jest już dostępna.',
  'chat.workStatus.pty.outputUnavailable': 'Nie udało się wczytać wyjścia PTY.',
  'chat.workStatus.pty.refreshFailed': 'Odświeżanie nie powiodło się; wyświetlane jest ostatnie dostępne wyjście.',
