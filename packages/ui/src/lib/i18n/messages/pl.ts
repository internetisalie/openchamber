...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.agentPtys': 'PTY agentów',
  'terminalView.pty.unavailable.title': 'PTY agentów są niedostępne',
  'terminalView.pty.unavailable.description': 'Ten widok jest dostępny, gdy OpenChamber zarządza procesem OpenCode.',
  'terminalView.pty.empty.sessions': 'Brak aktywnych PTY agentów.',
  'terminalView.pty.empty.output': 'Brak danych wyjściowych.',
  'terminalView.pty.status.running': 'Działa',
  'terminalView.pty.status.stopping': 'Zatrzymywanie',
  'terminalView.pty.status.exited': 'Zakończono',
  'terminalView.pty.readOnly': 'Tylko do odczytu',
  'terminalView.pty.error.load': 'Nie udało się wczytać PTY agentów.',
