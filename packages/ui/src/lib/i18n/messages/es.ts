...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.agentPtys': 'PTY de agentes',
  'terminalView.pty.unavailable.title': 'Los PTY de agentes no están disponibles',
  'terminalView.pty.unavailable.description': 'Esta vista está disponible cuando OpenChamber administra el proceso de OpenCode.',
  'terminalView.pty.empty.sessions': 'No hay PTY de agentes activos.',
  'terminalView.pty.empty.output': 'Aún no hay salida.',
  'terminalView.pty.status.running': 'En ejecución',
  'terminalView.pty.status.stopping': 'Deteniéndose',
  'terminalView.pty.status.exited': 'Finalizado',
  'terminalView.pty.readOnly': 'Solo lectura',
  'terminalView.pty.error.load': 'No se pudieron cargar los PTY de agentes.',
