...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': 'PTY del agente',
  'chat.workStatus.pty.authenticationError': 'Error de autenticación',
  'chat.workStatus.pty.availabilityUnknown': 'La disponibilidad de PTY es desconocida',
  'chat.workStatus.pty.none': 'No hay PTY para esta sesión',
  'chat.workStatus.pty.running': 'En ejecución',
  'chat.workStatus.pty.stopping': 'Deteniendo',
  'chat.workStatus.pty.exited': 'Finalizado',
  'chat.workStatus.pty.openOutput': 'Abrir la salida de {name}',
  'chat.workStatus.pty.readOnly': 'Solo lectura',
  'chat.workStatus.pty.dialogDescription': 'Salida de solo lectura de este PTY del agente.',
  'chat.workStatus.pty.outputMissing': 'Esta sesión de PTY ya no está disponible.',
  'chat.workStatus.pty.outputUnavailable': 'No se pudo cargar la salida del PTY.',
  'chat.workStatus.pty.refreshFailed': 'La actualización falló; se muestra la última salida disponible.',
