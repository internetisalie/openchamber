...
export const dict = {
  ...
  'chat.workStatus.pty.authenticationError': 'Authentication failed',
  'chat.workStatus.pty.availabilityUnknown': 'PTY availability is unknown',
  'chat.workStatus.pty.none': 'No PTYs for this session',
  'chat.workStatus.pty.running': 'Running',
  'chat.workStatus.pty.stopping': 'Stopping',
  'chat.workStatus.pty.exited': 'Exited',
  'chat.workStatus.pty.openOutput': 'Open output for {name}',
  'chat.workStatus.pty.readOnly': 'Read only',
  'chat.workStatus.pty.dialogDescription': 'Read-only output from this agent PTY.',
  'chat.workStatus.pty.outputMissing': 'This PTY session is no longer available.',
  'chat.workStatus.pty.outputUnavailable': 'PTY output could not be loaded.',
  'chat.workStatus.pty.refreshFailed': 'Refresh failed; showing the last available output.',
