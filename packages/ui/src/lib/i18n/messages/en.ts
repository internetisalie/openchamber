...
export const dict = {
  ...
  'terminalView.source.agentPtys': 'Agent PTYs',
  'terminalView.pty.unavailable.title': 'Agent PTYs are unavailable',
  'terminalView.pty.unavailable.description': 'This view is available when OpenChamber manages the OpenCode process.',
  'terminalView.pty.empty.sessions': 'No agent PTYs are active.',
  'terminalView.pty.empty.output': 'No output yet.',
  'terminalView.pty.status.running': 'Running',
  'terminalView.pty.status.stopping': 'Stopping',
  'terminalView.pty.status.exited': 'Exited',
  'terminalView.pty.readOnly': 'Read only',
  'terminalView.pty.error.load': 'Could not load agent PTYs.',
