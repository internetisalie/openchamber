...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': '代理 PTY',
  'chat.workStatus.pty.authenticationError': '驗證失敗',
  'chat.workStatus.pty.availabilityUnknown': '無法確定 PTY 是否可用',
  'chat.workStatus.pty.none': '此工作階段沒有 PTY',
  'chat.workStatus.pty.running': '執行中',
  'chat.workStatus.pty.stopping': '正在停止',
  'chat.workStatus.pty.exited': '已結束',
  'chat.workStatus.pty.openOutput': '開啟 {name} 的輸出',
  'chat.workStatus.pty.readOnly': '唯讀',
  'chat.workStatus.pty.dialogDescription': '此代理 PTY 的唯讀輸出。',
  'chat.workStatus.pty.outputMissing': '此 PTY 工作階段已無法使用。',
  'chat.workStatus.pty.outputUnavailable': '無法載入 PTY 輸出。',
  'chat.workStatus.pty.refreshFailed': '重新整理失敗；目前顯示最後可用的輸出。',
