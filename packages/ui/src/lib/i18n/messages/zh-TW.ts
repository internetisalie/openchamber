...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': '終端',
  'terminalView.source.agentPtys': '代理程式 PTY',
  'terminalView.pty.unavailable.title': '代理程式 PTY 無法使用',
  'terminalView.pty.unavailable.description': '當 OpenChamber 管理 OpenCode 程序時，此檢視可用。',
  'terminalView.pty.empty.sessions': '沒有使用中的代理程式 PTY。',
  'terminalView.pty.empty.output': '尚無輸出。',
  'terminalView.pty.status.running': '執行中',
  'terminalView.pty.status.stopping': '正在停止',
  'terminalView.pty.status.exited': '已結束',
  'terminalView.pty.readOnly': '唯讀',
  'terminalView.pty.error.load': '無法載入代理程式 PTY。',
