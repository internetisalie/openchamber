...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': 'エージェント PTY',
  'chat.workStatus.pty.authenticationError': '認証に失敗しました',
  'chat.workStatus.pty.availabilityUnknown': 'PTY の利用可否を確認できません',
  'chat.workStatus.pty.none': 'このセッションには PTY がありません',
  'chat.workStatus.pty.running': '実行中',
  'chat.workStatus.pty.stopping': '停止中',
  'chat.workStatus.pty.exited': '終了',
  'chat.workStatus.pty.openOutput': '{name} の出力を開く',
  'chat.workStatus.pty.readOnly': '読み取り専用',
  'chat.workStatus.pty.dialogDescription': 'このエージェント PTY の読み取り専用出力です。',
  'chat.workStatus.pty.outputMissing': 'この PTY セッションは利用できなくなりました。',
  'chat.workStatus.pty.outputUnavailable': 'PTY の出力を読み込めませんでした。',
  'chat.workStatus.pty.refreshFailed': '更新に失敗したため、最後に取得した出力を表示しています。',
