...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': 'ターミナル',
  'terminalView.source.agentPtys': 'エージェント PTY',
  'terminalView.pty.unavailable.title': 'エージェント PTY を利用できません',
  'terminalView.pty.unavailable.description': 'OpenChamber が OpenCode プロセスを管理している場合に利用できます。',
  'terminalView.pty.empty.sessions': '実行中のエージェント PTY はありません。',
  'terminalView.pty.empty.output': '出力はまだありません。',
  'terminalView.pty.status.running': '実行中',
  'terminalView.pty.status.stopping': '停止中',
  'terminalView.pty.status.exited': '終了',
  'terminalView.pty.readOnly': '読み取り専用',
  'terminalView.pty.error.load': 'エージェント PTY を読み込めませんでした。',
