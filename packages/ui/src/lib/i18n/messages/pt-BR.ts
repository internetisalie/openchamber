...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': 'Terminal',
  'terminalView.source.agentPtys': 'PTYs dos agentes',
  'terminalView.pty.unavailable.title': 'Os PTYs dos agentes não estão disponíveis',
  'terminalView.pty.unavailable.description': 'Esta visualização está disponível quando o OpenChamber gerencia o processo do OpenCode.',
  'terminalView.pty.empty.sessions': 'Não há PTYs de agentes ativos.',
  'terminalView.pty.empty.output': 'Ainda não há saída.',
  'terminalView.pty.status.running': 'Em execução',
  'terminalView.pty.status.stopping': 'Encerrando',
  'terminalView.pty.status.exited': 'Encerrado',
  'terminalView.pty.readOnly': 'Somente leitura',
  'terminalView.pty.error.load': 'Não foi possível carregar os PTYs dos agentes.',
