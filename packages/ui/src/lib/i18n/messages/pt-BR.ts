...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': 'PTYs do agente',
  'chat.workStatus.pty.authenticationError': 'Falha na autenticação',
  'chat.workStatus.pty.availabilityUnknown': 'A disponibilidade do PTY é desconhecida',
  'chat.workStatus.pty.none': 'Nenhum PTY para esta sessão',
  'chat.workStatus.pty.running': 'Em execução',
  'chat.workStatus.pty.stopping': 'Encerrando',
  'chat.workStatus.pty.exited': 'Encerrado',
  'chat.workStatus.pty.openOutput': 'Abrir a saída de {name}',
  'chat.workStatus.pty.readOnly': 'Somente leitura',
  'chat.workStatus.pty.dialogDescription': 'Saída somente leitura deste PTY do agente.',
  'chat.workStatus.pty.outputMissing': 'Esta sessão de PTY não está mais disponível.',
  'chat.workStatus.pty.outputUnavailable': 'Não foi possível carregar a saída do PTY.',
  'chat.workStatus.pty.refreshFailed': 'A atualização falhou; mostrando a última saída disponível.',
