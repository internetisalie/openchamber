...
export const dict = {
  ...
  'terminalView.source.agentPtys': 'PTY des agents',
  'terminalView.pty.unavailable.title': 'Les PTY des agents ne sont pas disponibles',
  'terminalView.pty.unavailable.description': 'Cette vue est disponible lorsque OpenChamber gère le processus OpenCode.',
  'terminalView.pty.empty.sessions': 'Aucun PTY d’agent n’est actif.',
  'terminalView.pty.empty.output': 'Aucune sortie pour le moment.',
  'terminalView.pty.status.running': 'En cours',
  'terminalView.pty.status.stopping': 'Arrêt en cours',
  'terminalView.pty.status.exited': 'Terminé',
  'terminalView.pty.readOnly': 'Lecture seule',
  'terminalView.pty.error.load': 'Impossible de charger les PTY des agents.',
