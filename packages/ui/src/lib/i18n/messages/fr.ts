...
export const dict = {
  ...
  'chat.workStatus.section.ptys': 'PTY de l\'agent',
  'chat.workStatus.pty.authenticationError': 'Échec de l\'authentification',
  'chat.workStatus.pty.availabilityUnknown': 'Disponibilité du PTY inconnue',
  'chat.workStatus.pty.none': 'Aucun PTY pour cette session',
  'chat.workStatus.pty.running': 'En cours',
  'chat.workStatus.pty.stopping': 'Arrêt en cours',
  'chat.workStatus.pty.exited': 'Terminé',
  'chat.workStatus.pty.openOutput': 'Ouvrir la sortie de {name}',
  'chat.workStatus.pty.readOnly': 'Lecture seule',
  'chat.workStatus.pty.dialogDescription': 'Sortie en lecture seule de ce PTY d\'agent.',
  'chat.workStatus.pty.outputMissing': 'Cette session PTY n\'est plus disponible.',
  'chat.workStatus.pty.outputUnavailable': 'Impossible de charger la sortie du PTY.',
  'chat.workStatus.pty.refreshFailed': 'Échec de l\'actualisation ; la dernière sortie disponible est affichée.',
