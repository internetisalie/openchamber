...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.pty.authenticationError': '身份验证失败',
  'chat.workStatus.pty.availabilityUnknown': '无法确定 PTY 是否可用',
  'chat.workStatus.pty.none': '此会话没有 PTY',
  'chat.workStatus.pty.running': '运行中',
  'chat.workStatus.pty.stopping': '正在停止',
  'chat.workStatus.pty.exited': '已退出',
  'chat.workStatus.pty.openOutput': '打开 {name} 的输出',
  'chat.workStatus.pty.readOnly': '只读',
  'chat.workStatus.pty.dialogDescription': '此代理 PTY 的只读输出。',
  'chat.workStatus.pty.outputMissing': '此 PTY 会话已不可用。',
  'chat.workStatus.pty.outputUnavailable': '无法加载 PTY 输出。',
  'chat.workStatus.pty.refreshFailed': '刷新失败；正在显示最后可用的输出。',
