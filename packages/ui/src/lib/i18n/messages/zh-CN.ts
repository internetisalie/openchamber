...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': '终端',
  'terminalView.source.agentPtys': '代理 PTY',
  'terminalView.pty.unavailable.title': '代理 PTY 不可用',
  'terminalView.pty.unavailable.description': '当 OpenChamber 管理 OpenCode 进程时，此视图可用。',
  'terminalView.pty.empty.sessions': '没有活动的代理 PTY。',
  'terminalView.pty.empty.output': '暂无输出。',
  'terminalView.pty.status.running': '运行中',
  'terminalView.pty.status.stopping': '正在停止',
  'terminalView.pty.status.exited': '已退出',
  'terminalView.pty.readOnly': '只读',
  'terminalView.pty.error.load': '无法加载代理 PTY。',
