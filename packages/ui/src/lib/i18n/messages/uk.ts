...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': 'Термінал',
  'terminalView.source.agentPtys': 'PTY агентів',
  'terminalView.pty.unavailable.title': 'PTY агентів недоступні',
  'terminalView.pty.unavailable.description': 'Це подання доступне, коли OpenChamber керує процесом OpenCode.',
  'terminalView.pty.empty.sessions': 'Немає активних PTY агентів.',
  'terminalView.pty.empty.output': 'Виводу ще немає.',
  'terminalView.pty.status.running': 'Працює',
  'terminalView.pty.status.stopping': 'Зупиняється',
  'terminalView.pty.status.exited': 'Завершено',
  'terminalView.pty.readOnly': 'Лише читання',
  'terminalView.pty.error.load': 'Не вдалося завантажити PTY агентів.',
