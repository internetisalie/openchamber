...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.section.ptys': 'PTY агента',
  'chat.workStatus.pty.authenticationError': 'Помилка автентифікації',
  'chat.workStatus.pty.availabilityUnknown': 'Доступність PTY невідома',
  'chat.workStatus.pty.none': 'Для цієї сесії немає PTY',
  'chat.workStatus.pty.running': 'Працює',
  'chat.workStatus.pty.stopping': 'Зупиняється',
  'chat.workStatus.pty.exited': 'Завершено',
  'chat.workStatus.pty.openOutput': 'Відкрити вивід {name}',
  'chat.workStatus.pty.readOnly': 'Лише для читання',
  'chat.workStatus.pty.dialogDescription': 'Вивід цього PTY агента лише для читання.',
  'chat.workStatus.pty.outputMissing': 'Ця сесія PTY більше недоступна.',
  'chat.workStatus.pty.outputUnavailable': 'Не вдалося завантажити вивід PTY.',
  'chat.workStatus.pty.refreshFailed': 'Не вдалося оновити; показано останній доступний вивід.',
