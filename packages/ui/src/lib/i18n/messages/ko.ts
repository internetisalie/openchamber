...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.source.terminal': '터미널',
  'terminalView.source.agentPtys': '에이전트 PTY',
  'terminalView.pty.unavailable.title': '에이전트 PTY를 사용할 수 없음',
  'terminalView.pty.unavailable.description': 'OpenChamber가 OpenCode 프로세스를 관리할 때 사용할 수 있습니다.',
  'terminalView.pty.empty.sessions': '활성 에이전트 PTY가 없습니다.',
  'terminalView.pty.empty.output': '아직 출력이 없습니다.',
  'terminalView.pty.status.running': '실행 중',
  'terminalView.pty.status.stopping': '중지 중',
  'terminalView.pty.status.exited': '종료됨',
  'terminalView.pty.readOnly': '읽기 전용',
  'terminalView.pty.error.load': '에이전트 PTY를 불러올 수 없습니다.',
