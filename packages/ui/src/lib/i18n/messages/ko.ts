...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.activity.globalTitle': '전역',
  ...
  'chat.workStatus.section.ptys': '에이전트 PTY',
  'chat.workStatus.pty.authenticationError': '인증에 실패했습니다',
  'chat.workStatus.pty.availabilityUnknown': 'PTY 사용 가능 여부를 확인할 수 없습니다',
  'chat.workStatus.pty.none': '이 세션에 PTY가 없습니다',
  'chat.workStatus.pty.running': '실행 중',
  'chat.workStatus.pty.stopping': '중지 중',
  'chat.workStatus.pty.exited': '종료됨',
  'chat.workStatus.pty.openOutput': '{name} 출력 열기',
  'chat.workStatus.pty.readOnly': '읽기 전용',
  'chat.workStatus.pty.dialogDescription': '이 에이전트 PTY의 읽기 전용 출력입니다.',
  'chat.workStatus.pty.outputMissing': '이 PTY 세션은 더 이상 사용할 수 없습니다.',
  'chat.workStatus.pty.outputUnavailable': 'PTY 출력을 불러올 수 없습니다.',
  'chat.workStatus.pty.refreshFailed': '새로 고침에 실패하여 마지막으로 사용 가능한 출력을 표시합니다.',
